...
class EquipController extends Controller
{
    ...
    {
        $equips = Equip::with('jugadoras', 'estadi')->get();
    ...
    {
        $edadMedia = $equip->edadMediaJugadoras();
        $ultimsPartits = $equip->ultimsPartits();
        return view('equips.show', compact('equip', 'edadMedia', 'ultimsPartits'));
    }
